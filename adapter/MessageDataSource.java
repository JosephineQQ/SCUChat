...
public class MessageDataSource {
    private static final Firebase sRef = new Firebase("https://luminous-torch-6176.firebaseio.com");
    ...
    public static void saveMessage(myMessage message, String convoId){
